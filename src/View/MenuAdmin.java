...
public class MenuAdmin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        lblManageMembers = new javax.swing.JLabel();
        ...
        jPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(860, 0, 220, 60));
        ...
        jPanel4.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 0, 170, 60));

        jPanel2.add(jPanel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 20, 270, 60));
        ...
        jPanel2.add(jPanel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 420, -1, 50));

        lblManageBooks.setFont(new java.awt.Font("Times New Roman", 0, 18)); // NOI18N
        lblManageBooks.setForeground(new java.awt.Color(255, 255, 255));
        lblManageBooks.setIcon(new javax.swing.ImageIcon(getClass().getResource("/View/icons8-books-50.png"))); // NOI18N
        lblManageBooks.setText("Manage Books");
        lblManageBooks.setPreferredSize(new java.awt.Dimension(78, 21));
        lblManageBooks.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                lblManageBooksMouseClicked(evt);
            }
        });
        jPanel2.add(lblManageBooks, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 90, 250, 60));

        lblManageMembers.setFont(new java.awt.Font("Times New Roman", 0, 18)); // NOI18N
        lblManageMembers.setForeground(new java.awt.Color(255, 255, 255));
        lblManageMembers.setIcon(new javax.swing.ImageIcon(getClass().getResource("/View/icons8-people-50.png"))); // NOI18N
        lblManageMembers.setText("Manage Members");
        lblManageMembers.setPreferredSize(new java.awt.Dimension(78, 21));
        lblManageMembers.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                lblManageMembersMouseClicked(evt);
            }
        });
        jPanel2.add(lblManageMembers, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 160, 240, 50));

        lblIssuedBook.setFont(new java.awt.Font("Times New Roman", 0, 18)); // NOI18N
        lblIssuedBook.setForeground(new java.awt.Color(255, 255, 255));
        lblIssuedBook.setIcon(new javax.swing.ImageIcon(getClass().getResource("/View/icons8-course-assign-48.png"))); // NOI18N
        lblIssuedBook.setText("Issued Book");
        lblIssuedBook.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                lblIssuedBookMouseClicked(evt);
            }
        });
        jPanel2.add(lblIssuedBook, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 230, 250, 60));

        lblReturnBook.setFont(new java.awt.Font("Times New Roman", 0, 18)); // NOI18N
        lblReturnBook.setForeground(new java.awt.Color(255, 255, 255));
        lblReturnBook.setIcon(new javax.swing.ImageIcon(getClass().getResource("/View/icons8-records-64.png"))); // NOI18N
        ...
        jPanel2.add(lblReturnBook, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 300, 260, -1));
        ...
        jPanel5.add(lblViewIssuedBook, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 10, -1, -1));
        ...
        jPanel5.add(lblViewRecords, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 10, -1, -1));

        jPanel14.add(jPanel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 340, 820, 80));
    ...
    private void lblManageMembersMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblManageMembersMouseClicked
        new MemberManagement().setVisible(true);
        dispose();
    }//GEN-LAST:event_lblManageMembersMouseClicked

    private void lblIssuedBookMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblIssuedBookMouseClicked
        new IssuedBooks().setVisible(true);
        dispose();
    }//GEN-LAST:event_lblIssuedBookMouseClicked
    ...
    private void logout() {
        ...
        if (choice == JOptionPane.YES_OPTION) {
            ...
            new MenuAdmin().setVisible(false);  // Replace with your login frame
        }
    }
    ...
    private javax.swing.JLabel lblManageMembers;
